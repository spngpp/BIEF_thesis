...
if ~isfile('VAT_Model22.mod') || ~isfile('VAT_Model23.mod') || ...
        ~isfile('VAT_Model23_Flexible.mod')
    error(['VAT_Model22.mod, VAT_Model23.mod, VAT_Model23_Flexible.mod ', ...
...
dynare VAT_Model22 noclearall nolog
dynare VAT_Model23 noclearall nolog
dynare VAT_Model23_Flexible noclearall nolog
...
function set_variable_title(ax,words,symbol)
    ...
    title(ax,'')
    if isempty(symbol)
        t_words = text(ax,0.5,y_title,words, ...
